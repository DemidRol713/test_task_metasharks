"""
Django settings for test_task_metasharks project.
...
TEMPLATES = [
    {
       ...
       'APP_DIRS': True,
       'OPTIONS': {
         'environment': 'test_task_metasharks.jinja2.environment'
       },
    },
    {
...
MAIN_MENU = [
    ...
    {'name': 'create_order', "title": "Создание заказа"},
    {'name': 'list_orders', 'title': 'Список заказов'},
]
